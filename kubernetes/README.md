...
```
$ docker image tag store mhamed3476/store
$ docker push mhamed3476/store
$ docker image tag invoice mhamed3476/invoice
$ docker push mhamed3476/invoice
$ docker image tag notification mhamed3476/notification
$ docker push mhamed3476/notification
$ docker image tag product mhamed3476/product
$ docker push mhamed3476/product
```
